    ...
    return (
      <Fragment>
        ...
        >
          ...
          <span className="var-highlight"> Gaurang Bharti</span>
          <span className="comment-highlight">
            {" "}
            implements SoftwareEngineer{" "}
          </span>
          &#123;;
        </pre>
        <pre
        ...
        >
          ...
          <span className="string-highlight"> "3 years";</span>
        </pre>
        <pre
          id="typewriter3"
          className="typewriter"
        ...
        >
          ...
          <span className="string-highlight"> "University of British Columbia"</span>;;
        </pre>
        <pre
          id="typewriter4"
          className="typewriter"
        ...
        >
          ...
          <span className="string-highlight"> "Bachelors of Science in Computer Science"</span>;;
        </pre>
        <pre
          id="typewriter5"
          className="typewriter"
        ...
        >
          ...
          <span className="string-highlight"> 2024</span>;
